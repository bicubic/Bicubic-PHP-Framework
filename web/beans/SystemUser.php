...
class SystemUser extends DataObject {
    ...
    public function __getProperties() {
        return array(
            ...
            "sessiontoken" => ["name" => "sessiontoken", "type" => PropertyTypes::$_STRING1024, "required" => false, "default" => "", "serializable" => true, "index" => false, "reference" => null, "updatenull" => true, "hidden" => false, "private" => false],
            "confirmemailtoken" => ["name" => "confirmemailtoken", "type" => PropertyTypes::$_STRING1024, "required" => false, "default" => null, "serializable" => true, "index" => true, "reference" => null, "updatenull" => true, "hidden" => false, "private" => false],
            "forgottoken" => ["name" => "forgottoken", "type" => PropertyTypes::$_STRING1024, "required" => false, "default" => null, "serializable" => true, "index" => true, "reference" => null, "updatenull" => true, "hidden" => false, "private" => false],
            "changeemailtoken" => ["name" => "changeemailtoken", "type" => PropertyTypes::$_STRING1024, "required" => false, "default" => null, "serializable" => true, "index" => true, "reference" => null, "updatenull" => true, "hidden" => false, "private" => false],
