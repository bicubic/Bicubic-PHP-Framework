...
require_once 'lib/ext/pear/HTTP/OAuth/Store/Data.php';
require_once 'lib/ext/pear/HTTP/OAuth/Store/Consumer/Interface.php';
require_once 'lib/ext/pear/Cache/Lite.php';
