...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    function _calcSheetOffsets()
    {
        ...
        if ($this->_BIFF_version == 0x0600) {
            ...
            /* : check this works for a lot of strings (> 8224 bytes) */
            ...
            //$offset += 8; // : calculate real value when storing the records
        }
        $total_worksheets = count($this->_worksheets);
    ...
    * : inconsistent with BIFF documentation
    *
        ...
        */
        ...
        foreach (array_keys($this->_str_table) as $string) {
            ...
            while ($block_length >= $continue_limit) {
                ...
                /* : Unicode data should only be split on char (2 byte)
