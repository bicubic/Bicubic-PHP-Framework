...
require_once 'lib/ext/pear/HTTP/OAuth.php';
require_once 'lib/ext/pear/HTTP/OAuth/Consumer/Request.php';
require_once 'lib/ext/pear/HTTP/OAuth/Consumer/Exception/InvalidResponse.php';
